...
def testObservations(output_dir=''):
    ...
    observations_test_0 = OC.index(aggs='city',
    ...
    jsonTools.writeJson(observations_test_1,
                        os.path.join(output_dir, r'observations_show.json'))

    observations_test_2 = OC.preview(temp_id)
    jsonTools.writeJson(observations_test_2['url'],
                        os.path.join(output_dir, r'observations_preview.json'))

    observations_test_3 = OC.downloadImages(
