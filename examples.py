...
def testCameras(output_dir=''):
    ...
    cameras_test_3 = cameras.showImage(cam_id, cameras_test_2['times'])
    jsonTools.writeJson(cameras_test_3,
                        os.path.join(output_dir, r'cameras_showImages.json'))

    cameras_test_4 = cameras.downloadImages(
        cameras_test_3['url'],
...
def testObservations(output_dir=''):
    ...
    observations_test_3 = observations.downloadImages(
...
def testCollections(output_dir=''):
    ...
    collections_test_5 = collections.showImage(
    ...
    collections_test6 = collections.downloadImages(
